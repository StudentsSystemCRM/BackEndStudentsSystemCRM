...
import edutrack.dto.request.accounting.*;
import edutrack.dto.response.accounting.*;
...
public class AccountingManagementServiceTest {
	...
	public void testRegistration_userAlreadyExists() {
		...
		when(userRepository.findByEmail(userRegisterRequest.getEmail())).thenReturn(new User());
