...
public class StudentServiceTest {
	...
	public void setUp() {
		groupStudent = new GroupEntity(1L, "Example Group", "example-whatsapp", "example-skype", "example-slack",
				...
				new HashSet<>(), new ArrayList<>(), new HashMap<>(), new HashMap<>(), ZonedDateTime.of(2024, 1, 1,1,1,1,1,ZoneId.of("Asia/Kuala_Lumpur")),"",ZonedDateTime.of(2024, 1, 1,1,1,1,1,ZoneId.of("Asia/Kuala_Lumpur")), "");
		...
		updateDataRequest = new StudentUpdateDataRequest(1L, "John", "Doe", "123456789", "john.doe@example.com",
				"New City", "New Course", "New Source", LeadStatus.STUDENT);
	}
